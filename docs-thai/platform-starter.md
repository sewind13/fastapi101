...
ถ้าต้องการ preset ที่ copy ไปใช้ได้เร็ว ให้ดู `core-only`, `redis-enabled`, และ `full-async` ใน [adoption-checklists.md](/Users/pluto/Documents/git/fastapi101/docs-thai/adoption-checklists.md)
