...
ค่า default จะเน้นความยาวเป็นหลัก: อย่างน้อย 12 ตัวอักษร, ต้องมี lowercase, ห้ามมี username/email local-part และยังไม่บังคับสูตร uppercase/digit/special แบบแข็งเกินไป ผู้ใช้ template สามารถ tighten เพิ่มใน production ได้โดยไม่ต้องแก้ code
