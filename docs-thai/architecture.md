...
ถ้าจะดูภาพรวม table และความสัมพันธ์ของ schema โดยตรง ให้เปิด [database-schema.md](../docs-thai/database-schema.md)

ถ้าจะเปลี่ยน schema จริง ๆ แบบ step-by-step ให้เปิด [database-migrations.md](../docs-thai/database-migrations.md)
...
อ่านเวอร์ชันอังกฤษแบบละเอียดได้ที่ [docs/architecture.md](../docs/architecture.md)
